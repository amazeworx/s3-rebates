...
assert.strictEqual(calculateTotalEarned(levels2), 1000, 'Level 15 should give 1000 medals (500+500)');

const levels3 = {
  'Thermal Lab-I': 20
};
// Expect 500 + 500 + 1000 = 2000
assert.strictEqual(calculateTotalEarned(levels3), 2000, 'Level 20 should give 2000 medals (500+500+1000)');
